...
public class ListaDeAcoesDeMovimentosDialog extends javax.swing.JDialog {
     ...
     */
    public ListaDeAcoesDeMovimentosDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(botaoAbrirDialogEscalonar)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaDeAcoesDeMovimentosDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListaDeAcoesDeMovimentosDialog dialog = new ListaDeAcoesDeMovimentosDialog(new javax.swing.JFrame(), true);
